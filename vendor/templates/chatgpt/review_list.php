...
<?php
    ...
    $posts = get_posts( array( // 'numberposts'   => -1,
        'post_type'     => 'ewm_worker_review' , // 'ewm_worker_review',    // 'meta_key'      => 'ewm_r_related_page_id',
        'post_status' => 'active', // 'post_parent'    => $post_id
...
<?php
    ...
    include dirname(__FILE__).'/ewm_wr_edit_review.php' ;
