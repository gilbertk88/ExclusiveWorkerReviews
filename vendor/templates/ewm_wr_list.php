...
<?php
    ...
    $posts = get_posts( array( // 'numberposts'   => -1,
        'post_type'         => 'ewm_worker_review', // 'meta_key' => 'ewm_r_related_page_id',
        'post_parent'       => $post_id,
        'posts_per_page'    => -1
    ) );
    ...
    if( !function_exists( 'ewm_wr_user_can_delete_worker_reviews' ) ){
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
            ...
            <?php
                ...
                foreach( $posts as $post_type => $post_value ){
                    ...
                    $ewm_r_review_date = array_key_exists( 'ewm_r_review_date', $post_meta_d ) ? $post_meta_d["ewm_r_review_date"][0] : 0 ;
